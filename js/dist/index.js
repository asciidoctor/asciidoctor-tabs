    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $super, $parent_nesting) {
        ...
        Opal.def(self, '$process', $Block_process$1 = function $$process(parent, reader, attrs) {
          var $a, $b, $$2, $$4, self = this, block = nil, children = nil, source_tabs = nil, doc = nil, id = nil, $writer = nil, reftext = nil, tabset_number = nil, tabs_id = nil, title = nil, tabs = nil, panes = nil, set_id_on_tab = nil;
          ...
          parent['$<<'](self.$create_html_fragment(parent, "" + "<div id=\"" + (tabs_id) + "\" class=\"tabset is-loading\">"));
          ...
          $send(source_tabs.$items(), 'each', [], ($$2 = function(labels, content){var self = $$2.$$s || this, $$3, $c, $d, tab_ids = nil, tab_blocks = nil, block0 = nil, blocks = nil;
            ...
            if ($truthy(content)) {
              ...
              tab_blocks = (function() {if ($truthy(content['$text?']())) {
                return [self.$create_paragraph(parent, content.$instance_variable_get("@text"), nil)]
              } else {
                return []
              }; return nil; })();
