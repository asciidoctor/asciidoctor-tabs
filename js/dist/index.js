  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $super, $parent_nesting) {
        ...
        var $nesting = [self].concat($parent_nesting), $Block_process$1, $Block_create_html_fragment$7, $Block_generate_id$8, $Block_list_item_supports_id$ques$9, $Block_reset_counter$12;
        ...
        Opal.def(self, '$process', $Block_process$1 = function $$process(parent, reader, attrs) {
          ...
          if ($truthy(($truthy($a = (($b = children.$size()['$=='](1)) ? (seed_tabs = children['$[]'](0)).$context()['$==']("dlist") : children.$size()['$=='](1))) ? seed_tabs['$items?']() : $a))) {
            ...
            return ($truthy($a = self.$reset_counter(doc, "tabs-number", $rb_minus(tabs_number, 1))) ? $a : block)
          };
          ...
          $send(seed_tabs.$items(), 'each', [], ($$2 = function(labels, content){var self = $$2.$$s || this, $$3, $c, $d, $e, $$4, tab_ids = nil, tab_blocks = nil, block0 = nil, blocks = nil;
            ...
            if ($truthy(content)) {
              ...
              if ($truthy(content['$blocks?']())) {
                ...
                if ($truthy(($truthy($c = ($truthy($d = (($e = (block0 = (blocks = content.$blocks())['$[]'](0)).$context()['$==']("open")) ? block0.$style()['$==']("open") : (block0 = (blocks = content.$blocks())['$[]'](0)).$context()['$==']("open"))) ? blocks.$size()['$=='](1) : $d)) ? ($truthy($d = ($truthy($e = block0.$id()) ? $e : block0['$title?']())) ? $d : $send(block0.$attributes().$keys(), 'any?', [], ($$4 = function(k){var self = $$4.$$s || this;
                  ...
                  return k['$!=']("style");}, $$4.$$s = self, $$4.$$arity = 1, $$4)))['$!']() : $c))) {
          ...
          tabs['$<<'](tablist);
          $send(panes, 'each', [], ($$5 = function(tab_ids, blocks){var self = $$5.$$s || this, $$6;
            ...
            $send(blocks, 'each', [], ($$6 = function(it){var self = $$6.$$s || this;
              ...
              return tabs['$<<'](it);}, $$6.$$s = self, $$6.$$arity = 1, $$6));
            return tabs['$<<'](self.$create_html_fragment(parent, "</div>"));}, $$5.$$s = self, $$5.$$arity = 2, $$5));
          return tabs;
        }, $Block_process$1.$$arity = 3);
        self.$private();
        
        Opal.def(self, '$create_html_fragment', $Block_create_html_fragment$7 = function $$create_html_fragment(parent, html, attributes) {
          var self = this;
        ...
        }, $Block_create_html_fragment$7.$$arity = -3);
        
        Opal.def(self, '$generate_id', $Block_generate_id$8 = function $$generate_id(str, doc, base_id) {
        ...
        }, $Block_generate_id$8.$$arity = -3);
        
        Opal.def(self, '$list_item_supports_id?', $Block_list_item_supports_id$ques$9 = function(doc) {
          var $$10, self = this, converter = nil, output = nil;
          ...
          if ($truthy((converter = doc.$converter())['$instance_variable_defined?']("@list_item_supports_id"))) {
            ...
            output = $send(self.$create_list(doc, "ulist"), 'tap', [], ($$10 = function(ul){var self = $$10.$$s || this, $$11;
              ...
              return ul['$<<']($send(self.$create_list_item(ul), 'tap', [], ($$11 = function(li){var self = $$11.$$s || this, $writer = nil;
                ...
                return $writer[$rb_minus($writer["length"], 1)];}, $$11.$$s = self, $$11.$$arity = 1, $$11)));}, $$10.$$s = self, $$10.$$arity = 1, $$10)).$convert();
            return converter.$instance_variable_set("@list_item_supports_id", output['$include?'](" id=\"name\""));
          }
        }, $Block_list_item_supports_id$ques$9.$$arity = 1);
        return (Opal.def(self, '$reset_counter', $Block_reset_counter$12 = function $$reset_counter(doc, name, val) {
          var self = this, $writer = nil;

          
          
          $writer = [name, val];
          $send(doc.$counters(), '[]=', Opal.to_a($writer));
          $writer[$rb_minus($writer["length"], 1)];;
          if ($truthy(doc['$attribute_locked?'](name))) {
          } else {
            doc.$set_attr(name, val)
          };
          return nil;
        }, $Block_reset_counter$12.$$arity = 3), nil) && 'reset_counter';
