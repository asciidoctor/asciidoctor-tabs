    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $super, $parent_nesting) {
        ...
        Opal.def(self, '$process', $Block_process$1 = function $$process(parent, reader, attrs) {
          var $a, $b, $$2, $$4, self = this, block = nil, children = nil, seed_tabs = nil, doc = nil, id = nil, $writer = nil, reftext = nil, tabs_number = nil, tabs_id = nil, sync = nil, tabs = nil, tablist = nil, panes = nil, set_id_on_tab = nil;
          ...
          tabs = self.$create_open_block(parent, nil, $hash2(["id", "role"], {"id": tabs_id, "role": "" + "tabs" + (($truthy($a = sync) ? $a : "")) + " is-loading"}));
