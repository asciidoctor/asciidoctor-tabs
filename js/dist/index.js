...
(function(Opal) {
  ...
  Opal.add_stubs(['$use_dsl', '$on_context', '$create_block', '$[]', '$blocks', '$parse_content', '$==', '$size', '$context', '$items?', '$attr?', '$document', '$id', '$register', '$id=', '$-', '$reftext?', '$set_attr', '$<<', '$counter', '$generate_id', '$!', '$option?', '$create_html_fragment', '$apply_subs', '$create_list', '$add_role', '$backend', '$list_item_supports_id?', '$each', '$items', '$map', '$text', '$instance_variable_get', '$text=', '$text?', '$create_paragraph', '$blocks?', '$push', '$[]=', '$join', '$private', '$attributes', '$delete', '$instance_variable_defined?', '$converter', '$convert', '$tap', '$create_list_item', '$instance_variable_set', '$include?']);
    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $super, $parent_nesting) {
        ...
        Opal.def(self, '$process', $Block_process$1 = function $$process(parent, reader, attrs) {
          var $a, $b, $$2, $$4, self = this, block = nil, children = nil, source_tabs = nil, doc = nil, id = nil, $writer = nil, reftext = nil, tabset_number = nil, tabs_id = nil, sync = nil, title = nil, tabs = nil, panes = nil, set_id_on_tab = nil;
          ...
          if ($truthy((doc = parent.$document())['$attr?']("filetype", "html"))) {
            ...
            if ($truthy(source_tabs.$id())) {
            } else {
              ($truthy($a = (id = attrs['$[]']("id"))) ? doc.$register("refs", [(($writer = [id]), $send(source_tabs, 'id=', Opal.to_a($writer)), $writer[$rb_minus($writer["length"], 1)]), source_tabs]) : $a)
            };
            if ($truthy(source_tabs['$reftext?']())) {
            } else {
          ...
          tabs_id = ($truthy($a = attrs['$[]']("id")) ? $a : self.$generate_id("" + "tabset " + (tabset_number), doc));
          sync = (function() {if ($truthy(($truthy($a = block['$option?']("nosync")['$!']()) ? ($truthy($b = block['$option?']("sync")) ? $b : doc['$option?']("tabs-sync")) : $a))) {
            return " is-sync"
          } else {
            return nil
          }; return nil; })();
          parent['$<<'](self.$create_html_fragment(parent, "" + "<div id=\"" + (tabs_id) + "\" class=\"tabset" + (($truthy($a = sync) ? $a : "")) + " is-loading\">"));
          if ($truthy((title = attrs['$[]']("title")))) {
            parent['$<<'](self.$create_html_fragment(parent, "" + "<div class=\"title\">" + (parent.$apply_subs(title)) + "</div>"))};
          tabs = self.$create_list(parent, "ulist");
          tabs.$add_role("tabs");
          panes = $hash2([], {});
          set_id_on_tab = ($truthy($a = doc.$backend()['$==']("html5")) ? $a : self['$list_item_supports_id?'](doc));
          $send(source_tabs.$items(), 'each', [], ($$2 = function(labels, content){var self = $$2.$$s || this, $$3, $c, $d, tab_ids = nil, tab_blocks = nil, block0 = nil, blocks = nil;
            ...
            tab_ids = $send(labels, 'map', [], ($$3 = function(tab){var self = $$3.$$s || this, tab_id = nil, tab_source_text = nil;
          ...
          return self.$create_html_fragment(parent, "</div>", $hash2(["id"], {"id": tabs_id}));
