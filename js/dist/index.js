    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $super, $parent_nesting) {
        ...
        Opal.def(self, '$process', $Block_process$1 = function $$process(parent, reader, attrs) {
          ...
          id = ($truthy($a = attrs['$[]']("id")) ? $a : "" + (($truthy($b = doc.$attributes()['$[]']("idprefix")) ? $b : "_")) + "tabset" + (($truthy($b = doc.$attributes()['$[]']("idseparator")) ? $b : "_")) + (tabset_number));
...
(function(Opal) {
  ...
  Opal.add_stubs(['$==', '$absolute_path', '$use_dsl', '$at_location', '$join', '$attr', '$empty?', '$read_asset', '$read_contents', '$chomp']);
  return (function($base, $parent_nesting) {
    var self = $module($base, 'Asciidoctor');
      ...
      (function($base, $parent_nesting) {
        ...
        (function($base, $super, $parent_nesting) {
          ...
          return (Opal.def(self, '$process', $Styles_process$1 = function $$process(doc) {
            ...
            if ($truthy((styles = (function() {if ($truthy(path['$empty?']())) {
        ...
        (function($base, $super, $parent_nesting) {
          ...
          return (Opal.def(self, '$process', $Behavior_process$2 = function $$process(doc) {
            var self = this, script = nil;

            
            if ($truthy((script = doc.$read_asset($$($nesting, 'JAVASCRIPT_FILE'))))) {
            } else {
              return nil
            };
            return "" + "<script>\n" + (script.$chomp()) + "\n</script>";
